    ...
    <section className="relative w-full bg-[#C5E1F3] overflow-hidden min-h-screen lg:min-h-[800px] flex items-center pt-[120px] pb-[60px] md:py-[120px]">
      ...
      <div className="absolute inset-0 max-w-[1440px] mx-auto w-full h-full pointer-events-none z-10">
        <img 
          ...
          alt="LunoBox Device" 
          className="absolute bottom-[-5%] right-[-15%] md:bottom-0 md:right-[-5%] lg:bottom-auto lg:right-auto lg:top-[113px] lg:left-[732px] w-[320px] md:w-[450px] lg:w-[628px] lg:h-[687px] object-contain drop-shadow-2xl pointer-events-auto hover:scale-[1.02] transition-transform duration-500" 
        />
      </div>
