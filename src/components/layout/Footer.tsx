  ...
  return (
    <footer className="w-full bg-[#DFEBF3] pt-[80px] pb-[40px] border-t border-[#3A5B93]/10 mt-auto">
      <div className="max-w-[1280px] mx-auto px-[16px] md:px-[40px]">
        ...
        {/* Üst Kısım: 5 Kolonlu Yapı */}
        <div className="flex flex-col lg:flex-row justify-between gap-[40px] lg:gap-[20px] mb-[60px]">
          
          {/* Kolon 1: YENİ LOGO (Navbar'da kullandığımız logo.svg) */}
          ...
          <div className="flex flex-col gap-[12px]">
            <span className="text-[#505050] font-bold text-[15px]">+90 212 706 16 32</span>
            <span className="text-[#505050] font-bold text-[15px]">+90 505 292 43 32</span>
            <a href="mailto:info@lunobox.com" className="text-[#505050] font-bold text-[15px] hover:text-[#3A5B93] transition-colors">info@lunobox.com</a>
            <span className="text-[#505050] font-bold text-[15px]">Istanbul, Turkiye</span>
            
            {/* Sosyal Medya İkonları (Figma'daki sarı renkli X, Instagram, Facebook) */}
            <div className="flex items-center gap-[16px] mt-[4px] text-[#F2BA44]">
          ...
          {/* Kolon 5: Mini Waitlist Formu (ŞİMDİ API'YE BAĞLI VE ÇALIŞIYOR!) */}
          <div className="flex flex-col gap-[12px] w-full lg:max-w-[280px]">
            {status === 'success' ? (
              <div className="w-full text-left p-[16px] bg-white/40 rounded-[12px] animate-fade-in border border-[#3A5B93]/10">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-[12px] w-full">
                <input 
                  ...
                  className="w-full h-[48px] rounded-[12px] bg-white px-[16px] text-[#505050] outline-none shadow-sm placeholder:text-[#505050]/40 border border-transparent focus:border-[#4168A6]/30 transition-colors disabled:opacity-50"
                  required
                />
                ...
                {/* MVP planında istenen gizli honeypot (bot koruması) alanı */}
                ...
                <p className="text-[#505050]/60 text-[12px]">
                  No spam. Just a gentle note when we're ready.
                </p>
                
                {/* Buton Tipi 'submit' olarak güncellendi ve loading durumu eklendi */}
                <button 
                  type="submit" 
                  disabled={status === 'loading'}
                  className="bg-[#F2BA44] hover:bg-[#E0A832] text-white font-bold text-[16px] px-[28px] py-[10px] rounded-full shadow-md transition-transform hover:-translate-y-1 self-start mt-[4px] disabled:opacity-70 disabled:hover:translate-y-0"
                >
        ...
        <div className="w-full flex justify-start border-t border-[#3A5B93]/20 pt-[24px]">
          <p className="text-[#505050]/60 text-[12px] font-medium">
